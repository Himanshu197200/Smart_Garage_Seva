...
const services = [
  { icon: <Wrench size={24} />, title: 'Job Card Management', desc: 'Track every job through its full lifecycle — from CREATED to ASSIGNED, IN_PROGRESS, COMPLETED, and DELIVERED. Full transparency for every stakeholder.', bg: '#EFF6FF', color: '#2563EB' },
  ...
  { icon: <Bell size={24} />, title: 'Smart Notifications', desc: 'Automated alerts for job status updates, low inventory warnings, service reminders, and payment notifications.', bg: '#DBEAFE', color: '#2563EB' },
  ...
  { icon: <BarChart3 size={24} />, title: 'Reports & Analytics', desc: 'Comprehensive dashboards showing job statistics, revenue metrics, inventory turnover, and mechanic performance.', bg: '#DBEAFE', color: '#2563EB' },
  { icon: <Shield size={24} />, title: 'Multi-Role Access Control', desc: 'Three distinct dashboards for Admins, Mechanics, and Customers — each with tailored views and appropriate permissions.', bg: '#EFF6FF', color: '#1E40AF' },
